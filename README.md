# Tienda Luxury store
Este es un proyecto de ecommerce básico que se utiliza para el curso de React. La aplicación permite ver una lista de productos de ropa y realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
