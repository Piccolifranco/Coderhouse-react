...
export const Item = ({ item }) => {
  return (
    <div className='grid text-white bg-gray-600 rounded-md'>
      <div className='h-60 w-full flex justify-center items-center bg-white p-6 rounded-t-md'>
        <img className='h-60 rounded-md p-10' src={item.image} alt='Imagen del producto' />
      </div>
      <div>
